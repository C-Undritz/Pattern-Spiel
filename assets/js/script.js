...
function viewTimer() {
    //let timeLeftDisplay = document.getElementById("game-triggers");
    ...
    document.getElementById('game-triggers').innerHTML = timerButton;
}

//function clearViewTimer() {
  //  console.log("clearing timer");
    //document.getElementById("game-triggers").innerHTML = "";
