...
* [Presentation of display testing](assets/readme/testing_pattern-spiel_display.pdf)
...
Functionality testing to ensure that the menu navigation, chosen game options, resulting gameplay and score functionality, was conducted on a desktop PC using Google Chrome.
...
Site was tested on the following browsers by using Lighthouse :
* Chrome
* Opera
* Edge
* Firefox
